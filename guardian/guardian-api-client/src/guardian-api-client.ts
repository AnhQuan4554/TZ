...
export class GuardianClientApi {
  ...
  private getRequestOptions(session: Session): any {
    return {
      headers: {
    ...
    return {
      balance: (session: Session) =>
        this.wrapperAxiosCall(
          () =>
            this.accountApi.accountsBalanceGet(this.getRequestOptions(session)),
          this.defaultRetry,
        )(),
    };
  }
  ...
  public auth() {
    return {
      ...
      register: (username: string, password: string, role: string) =>
        this.wrapperAxiosCall(
          () =>
            this.accountApi.accountsRegisterPost({
              username,
              password,
              role,
            } as any),
  ...
  public schema() {
    return {
      ...
      create: (session: Session, topicId: string, schema: Schema) =>
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasTopicIdPost(
              topicId,
              schema,
              this.getRequestOptions(session),
            ),
      ...
      push: (session: Session, topicId: string, schema: Schema) =>
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasPushTopicIdPost(
              topicId,
              schema,
              this.getRequestOptions(session),
            ),
      ...
      getAllByTopicId: (
        ...
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasTopicIdGet(
              topicId,
              pageIndex,
              pageSize,
              this.getRequestOptions(session),
      ...
      createWithTopic: (session: Session, schema: Schema) =>
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasTopicIdPost(
              schema.topicId || '',
      ...
      update: (session: Session, schemaId: string, schema: Schema) =>
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasSchemaIdPut(
              schemaId,
              schema,
              this.getRequestOptions(session),
            ),
      ...
      createStandardRegistry: (
        ...
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasSystemUsernamePost(
      ...
      getStandardRegistry: (
        ...
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasSystemUsernameGet(
              username || session.username,
              pageIndex,
              pageSize,
              this.getRequestOptions(session),
      ...
      activateStandardRegistry: (session: Session, schemaId: string) =>
        this.wrapperAxiosCall(
          () =>
            this.schemasApi.schemasSystemSchemaIdActivePut(
              schemaId,
              {},
              this.getRequestOptions(session),
            ),
  ...
  public policy() {
    return {
      ...
      getById: (session: Session, policyId: string) =>
        this.wrapperAxiosCall(
          () =>
            this.policiesApi.policiesPolicyIdGet(
              policyId,
              this.getRequestOptions(session),
            ),
          this.defaultRetry,
        )(),
      update: (session: Session, policyId: string, policy: PolicyConfig) =>
        this.wrapperAxiosCall(
          () =>
            this.policiesApi.policiesPolicyIdPut(
              policyId,
              policy,
              this.getRequestOptions(session),
            ),
  ...
  public profile() {
    return {
      ...
      getBalance: (session: Session, username?: string) =>
        this.wrapperAxiosCall(
          () =>
            this.profileApi.profilesUsernameBalanceGet(
              username || session.username,
              this.getRequestOptions(session),
            ),
          this.defaultRetry,
