...
export type IInstaller = {
  id: string;
  installerId: string; //Installer Id - Unique identifier for the installer
  installerName: string; //Installer Name - Business name for the installer
  ...
  certification: IDoc; //Certification - Image of the certification certificate
  certificationExpiryDate: any; //Certification Expiry Date - The date the certification certificate expires
  isPublished: boolean; //
};
