...
export type ITokenOwner = {
  tokenOwnerId: string; //Root Authority Id - Unique identifier
  tokenOwnerName: string; //Root Authority  Name - Business name for the Root Authority
