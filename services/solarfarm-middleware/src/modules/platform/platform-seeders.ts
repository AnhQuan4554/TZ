...
const seeders = [
  ['TymlezRECAggregationFields', '', '', 'System', null, 'true'],
  ['TymlezGooAggregationFields', '', '', 'System', null, 'true'],
  ['TymlezCETAggregationFields', '', '', 'System', null, 'true'],
  ['TymlezCRUAggregationFields', '', '', 'System', null, 'true'],
];
